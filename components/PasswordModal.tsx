      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl space-y-5 border border-slate-200">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900">Password-Protected Statement</h3>
              <p className="text-[11px] text-slate-500 line-clamp-1">{filename || 'Encrypted PDF Statement'}</p>
            </div>
          </div>
          <button
            onClick={onCancel}
        ...
        <div className="flex items-center gap-2 rounded-xl bg-emerald-50 p-3 border border-emerald-200/80 text-xs text-emerald-900">
          ...
          <span className="font-semibold">
            100% In-Browser Decryption: Your password never leaves your device.
          </span>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="PDF Password (case-sensitive)"
                value={password}
